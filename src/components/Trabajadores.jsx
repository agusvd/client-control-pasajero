                        ...
                        {trabajadores.map((trabajador) => (
                            <tr
                                ...
                                <td className="px-4 py-2 text-[#FAFAFA] gap-2 flex">
                                    <button className='bg-[#0A0A0B] text-[#FAFAFA] p-2 rounded-lg hover:bg-[#FAFAFA] hover:text-[#0A0A0B] transition-colors'>Editar</button>
                                    <button
                                        onClick={() => handleDelete(trabajador)}
                                        className='bg-[#0A0A0B] text-[#FAFAFA] p-2 rounded-lg hover:bg-[#FAFAFA] hover:text-[#0A0A0B] transition-colors'>Eliminar</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
